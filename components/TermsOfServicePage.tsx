        ...
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="flex flex-col lg:flex-row gap-12">
            ...
            <div className="lg:w-1/4">
              <div className="sticky top-24 bg-white p-6 rounded-xl border border-gray-100 shadow-sm transition-colors">
                <h3 className="font-bold mb-4 text-slate-900">Quick Navigation</h3>
              ...
              <div>
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  <div className="p-4 border border-gray-200 rounded-lg">
                    <h3 className="font-bold mb-1 text-slate-900">Trademark Registration</h3>
                    <p className="text-xs text-gray-500">Complete search, application preparation, filing, and prosecution services.</p>
                  </div>
                  <div className="p-4 border border-gray-200 rounded-lg">
                    <h3 className="font-bold mb-1 text-slate-900">Legal Consultation</h3>
                    <p className="text-xs text-gray-500">Expert advice on trademark law, brand protection strategies, and risk assessment.</p>
                  </div>
                </div>
              </div>
