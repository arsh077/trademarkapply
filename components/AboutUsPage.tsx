    ...
    <div className="bg-white text-gray-900 min-h-screen">
          ...
          <div className="flex flex-col md:flex-row gap-16 items-center">
            ...
            <div className="md:w-1/2">
               <div className="glass-panel p-1 rounded-3xl rotate-3 hover:rotate-0 transition-transform duration-500">
                 <div className="bg-gray-100 p-8 rounded-[20px] relative overflow-hidden">
                   ...
                   <div className="flex items-center gap-6 mb-8">
                     <div className="w-20 h-20 rounded-full bg-gray-100 flex items-center justify-center border border-gray-200">
                        <UserCheck size={32} className="text-gray-900" />
                     </div>
                     <div>
                       <h3 className="text-2xl font-bold text-gray-900">KHURSHID ANWAR</h3>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="group p-6 rounded-2xl hover:bg-gray-50 transition-colors border border-transparent hover:border-gray-100">
                <div className="w-12 h-12 bg-gray-50 rounded-xl flex items-center justify-center text-gray-700 mb-6 group-hover:text-gray-900 group-hover:scale-110 transition-all">
                  <item.icon size={24} />
                </div>
      ...
      <section className="py-24 border-t border-gray-100">
        <div className="container mx-auto px-4">
          ...
          <div className="relative border-l border-gray-200 ml-4 md:ml-1/2 space-y-12 pl-8 md:pl-0">
             {[
