...
const WhyChooseUs: React.FC = () => {
  return (
    <section className="py-24 bg-slate-50 transition-colors duration-300 relative">
      <div className="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/cubes.png')] opacity-[0.03]"></div>
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-3xl md:text-5xl font-bold mb-6 text-slate-900 tracking-tight">Why Choose TrademarkApply?</h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            ...
            <div key={idx} className="bg-white p-8 rounded-2xl shadow-sm border border-slate-100 text-center hover:-translate-y-2 transition-all duration-300 group">
              <div className={`inline-flex items-center justify-center w-16 h-16 bg-${item.color}-50 text-${item.color}-600 rounded-2xl mb-6 group-hover:scale-110 transition-transform`}>
                <item.icon size={32} />
              </div>
