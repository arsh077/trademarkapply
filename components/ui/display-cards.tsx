...
function DisplayCard({
  ...
  return (
    <div
      className={cn(
        "relative flex h-36 w-[18rem] sm:h-48 sm:w-[24rem] -skew-y-[8deg] select-none flex-col justify-between rounded-xl border-2 bg-white/90 backdrop-blur-sm px-4 py-3 sm:px-6 sm:py-4 transition-all duration-700 after:absolute after:-right-1 after:top-[-5%] after:h-[110%] after:w-[15rem] sm:after:w-[20rem] after:bg-gradient-to-l after:from-slate-50 after:to-transparent after:content-[''] hover:border-blue-200 hover:bg-white shadow-lg [&>*]:flex [&>*]:items-center [&>*]:gap-2",
        className
      )}
    >
      <div>
