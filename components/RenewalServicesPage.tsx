...
const RenewalServicesPage: React.FC<RenewalServicesPageProps> = ({ onNavigate }) => {
  ...
  return (
    <div className="bg-white transition-colors duration-300">
            ...
            <div>
              ...
              <div className="grid grid-cols-3 gap-4 max-w-lg mb-8">
                <div className="bg-gray-100 backdrop-blur-sm p-4 rounded-lg border border-gray-200 text-center">
                  ...
                  <div className="text-xs text-gray-800">Govt. fees</div>
                </div>
                <div className="bg-gray-100 backdrop-blur-sm p-4 rounded-lg border border-gray-200 text-center">
                  <div className="text-2xl font-bold text-secondary mb-1">2-3</div>
                  <div className="text-xs text-gray-800">Months Timeline</div>
                </div>
                <div className="bg-gray-100 backdrop-blur-sm p-4 rounded-lg border border-gray-200 text-center">
                  <div className="text-2xl font-bold text-secondary mb-1">10 Yrs</div>
                  <div className="text-xs text-gray-800">Extension</div>
                </div>
              </div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold mb-4 text-slate-900">Comprehensive Renewal Services</h2>
            <p className="text-gray-600">Our expert team provides end-to-end trademark renewal assistance</p>
          </div>
      ...
      {/* Form Section */}
      <section id="renewal-form" className="py-20 bg-slate-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4 text-slate-900">Renewal Handling Request</h2>
            <p className="text-gray-600">Please provide complete details about yourself or your business</p>
          </div>
              ...
              <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
                ...
                <form onSubmit={handleNext} className="space-y-6">
                    ...
                    <div className="animate-in fade-in slide-in-from-right duration-300">
                      ...
                      <div className="grid md:grid-cols-2 gap-6">
                        <div>
                          ...
                          <div className="relative">
                            ...
                            <input type="text" name="fullName" required className="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 outline-none" placeholder="Enter your full legal name" value={formData.fullName} onChange={handleChange} />
                          </div>
                        </div>
                        <div>
                          ...
                          <div className="relative">
                            ...
                            <input type="text" name="businessName" className="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 outline-none" placeholder="Enter business name" value={formData.businessName} onChange={handleChange} />
                          </div>
                        </div>
                        <div>
                          ...
                          <div className="relative">
                            ...
                            <input type="email" name="email" required className="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 outline-none" placeholder="your.email@example.com" value={formData.email} onChange={handleChange} />
                          </div>
                        </div>
                        <div>
                          ...
                          <div className="relative">
                            ...
                            <input type="tel" name="phone" required className="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 outline-none" placeholder="+91 7605890360" value={formData.phone} onChange={handleChange} />
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="mt-6">
                         ...
                         <div className="relative">
                            ...
                            <input type="text" name="address" required className="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 outline-none" placeholder="Enter your complete address" value={formData.address} onChange={handleChange} />
                         </div>
                      </div>
                      ...
                      <div className="grid md:grid-cols-3 gap-6 mt-6">
                        <div>
                          ...
                          <input type="text" name="city" required className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 outline-none" placeholder="Enter city name" value={formData.city} onChange={handleChange} />
                        </div>
                        <div>
                        ...
                        <div>
                          ...
                          <input type="text" name="pinCode" required className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 outline-none" placeholder="123456" value={formData.pinCode} onChange={handleChange} />
                        </div>
                      </div>
                    </div>
                  )}
                  ...
                  {step === 2 && (
                     <div className="animate-in fade-in slide-in-from-right duration-300">
                       <div className="mb-6">
                         <h3 className="text-xl font-bold text-slate-900">Trademark Details</h3>
                         <p className="text-sm text-gray-500">Provide info about the trademark to be renewed</p>
                       </div>
                       <div className="grid md:grid-cols-2 gap-6">
                          <div>
                             <label className="block text-sm font-bold text-gray-700 mb-1">Application No.</label>
                             <input type="text" className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 outline-none" placeholder="e.g. 1234567" />
                          </div>
                          <div>
                             <label className="block text-sm font-bold text-gray-700 mb-1">Current Expiry Date</label>
                             <input type="date" className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 outline-none" />
                          </div>
                       </div>
                     </div>
                  )}
                  ...
                  {step === 3 && (
                     <div className="animate-in fade-in slide-in-from-right duration-300">
                       ...
                       <p className="text-gray-600">Please confirm your details. Upon submission, our team will review the trademark status and contact you for the next steps.</p>
                     </div>
                  )}
              ...
              <div className="bg-white rounded-2xl shadow-lg p-6 border-t-4 border-orange-500">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500 font-medium">Trademark Renewal Specialist</p>
                  </div>
                </div>
                ...
                <div className="space-y-2 mb-6 text-sm">
                  ...
                  <div className="flex items-center gap-2 text-gray-600"><CheckCircle2 size={16} className="text-green-500" /> Thousands of renewals processed</div>
                  <div className="flex items-center gap-2 text-gray-600"><CheckCircle2 size={16} className="text-green-500" /> High Success Rate</div>
                  <div className="flex items-center gap-2 text-gray-600"><CheckCircle2 size={16} className="text-green-500" /> Portfolio Expert</div>
                </div>

                <div className="bg-orange-50 p-4 rounded-lg">
                   <h4 className="font-bold text-sm mb-2 text-orange-800">Specializations:</h4>
