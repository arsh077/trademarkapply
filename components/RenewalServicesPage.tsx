                      ...
                      <div className="grid md:grid-cols-2 gap-6">
                        ...
                        <div>
                          ...
                          <div className="relative">
                            ...
                            <input type="tel" name="phone" required className="w-full pl-10 pr-4 py-2.5 border border-gray-300 dark:border-slate-600 dark:bg-slate-700 dark:text-white rounded-lg focus:ring-2 focus:ring-orange-500 outline-none" placeholder="+91 7605890360" value={formData.phone} onChange={handleChange} />
                          </div>
                        </div>
                      </div>
