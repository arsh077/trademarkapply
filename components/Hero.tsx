      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          ...
          <div className="lg:w-1/2 space-y-8 text-center lg:text-left">
            <div className="inline-flex items-center gap-2 bg-gray-100 px-4 py-1.5 rounded-full text-secondary font-semibold text-sm backdrop-blur-md border border-gray-200 mx-auto lg:mx-0">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start pt-2">
              ...
              <GlassButton 
                ...
                className="bg-gray-50 backdrop-blur-sm border border-gray-300 text-gray-900 font-semibold hover:bg-gray-100"
              >
                Explore Services
              </GlassButton>
            </div>

            <div className="pt-6 flex items-center justify-center lg:justify-start gap-6 text-sm text-gray-600">
              <div className="flex items-center gap-2">
                <div className="flex -space-x-2">
                  {[1,2,3,4].map(i => (
                    <div key={i} className="w-8 h-8 rounded-full bg-gray-200 border-2 border-slate-900 flex items-center justify-center text-xs overflow-hidden">
              ...
              <div className="flex items-center gap-1">
                ...
                <span className="text-gray-900 font-bold">4.9/5</span> Rating
              </div>
            </div>
          </div>
            ...
            <div className="relative max-w-lg mx-auto lg:ml-auto">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="bg-gray-100 backdrop-blur-md p-6 rounded-2xl border border-gray-200 hover:bg-white/15 transition-colors">
                  ...
                  <div className="text-sm text-gray-700">Legal Consultation</div>
                </div>
                ...
                <div className="bg-gradient-to-br from-secondary to-yellow-600 p-6 rounded-2xl shadow-lg flex flex-col justify-center text-slate-900">
                   ...
                   <div className="mt-auto bg-gray-200 rounded-full h-1 w-full">
                     <div className="bg-gray-50/50 h-1 rounded-full w-3/4"></div>
                   </div>
                </div>
